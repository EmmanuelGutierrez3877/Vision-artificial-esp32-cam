...
<body class="center">
    <div id="menu" class="col-xs-11 col-sm-11 col-lg-7 menu">
        <table class="table">
            <tbody>
                <tr>
                    <td><a href="index.php">Actual</a></td>
                    <td><a href="see_all.php">Ver todas</a></td>
                </tr>
            </tbody>
        </table>
        </div>
    ...
    <div id="foto" class="col-xs-11 col-sm-11 col-lg-7 foto">
        <?php echo($foto['fecha']);
            //echo $foto['imagen'];
